...
spot_two = Spot.new(role: "digital artist", description: "Looking for someone who can work with digital projections to work with a live band", category: 2 )
...
profile_photo_three = "https://res.cloudinary.com/dqnhjr33l/image/upload/v1567016535/arhstrzmotloqekpe17h.jpg"
...
user_four = User.new(username: "Tommy123", first_name: "Tom", last_name: "Thomas", bio: "Strong leader guitarist, big into metal and psych rock also love to improvise", location: "Berlin", looking_for: "Rock Band Events", email: "tom@example.com", password: "123456", is_creative: true, skill: "lead guitar", style: "metal/rock/psych", category: 1)


cover_photo_three = "hhttps://res.cloudinary.com/dqnhjr33l/image/upload/v1567057654/thiago-borrere-alvim-bf8APnBxoCk-unsplash_az7c8h.jpg"
profile_photo_three = "https://res.cloudinary.com/dqnhjr33l/image/upload/v1567057566/zoolander_dhfvhh.jpg"
...
cover_photo_three = "https://res.cloudinary.com/dqnhjr33l/image/upload/v1567057906/680w_x395h_c-reduced_JLS_jsegvb.jpg"
profile_photo_three = "https://res.cloudinary.com/dqnhjr33l/image/upload/v1567016530/ytcznyr2gsn2xpffkc3i.jpg"
...
request_one = Request.new(status: 0, note: "Would love to work with you, check my profile to see my projections")
request_one.spot = spot_one
request_one.user_id = user_three.id
request_one.save!
